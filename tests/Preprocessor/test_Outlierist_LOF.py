...
class TestOutlierLOF:
    def test_LOF_no_outliers(self):
        ...
        df_data_setting = {'outlier_method': 'lof' , 'outlier_columns': ['A', 'B'], 'outlier_columns_action': ['A', 'B']}
        df_expected = pd.DataFrame({'A': [1.0, 2.0, 3.0], 'B': pd.to_datetime(['2020-10-01', '2020-10-02', '2020-10-03'])})
        
        # Create an instance of the class
        obj = Outlierist_LOF(df_data, **df_data_setting)
    ...
    def test_LOF_with_outliers(self):
        # Prepare test data
