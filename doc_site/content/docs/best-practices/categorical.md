...
Preprocessor:
  encoding_uniform:
    sequence:
      - 'encoder'
    encoder:
      birth_year: 'encoder_uniform'
      birth_month: 'encoder_uniform'
      birth_day: 'encoder_uniform'
      zodiac: 'encoder_uniform'
      deparment_code: 'encoder_uniform'
      department_name: 'encoder_uniform'
      admission_type_code: 'encoder_uniform'
      admission_type: 'encoder_uniform'
      disabled_code: 'encoder_uniform'
      disabled_type: 'encoder_uniform'
      nationality_code: 'encoder_uniform'
      nationality: 'encoder_uniform'
      identity_code: 'encoder_uniform'
      identity: 'encoder_uniform'
      sex: 'encoder_uniform'
```
