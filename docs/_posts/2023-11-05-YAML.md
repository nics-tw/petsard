...
For the third layer in YAML, the parameters for each module should be considered by users as a dictionary to pass in. In this case, the keys of the dictionary are the parameters of the module. Please see the example below:
